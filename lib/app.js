...
class App {
    ...
    putPrintStatement(editor) {
        return Promise.resolve().then(() => {
            ...
            const printStatementConfig = this._printStatementConfigService.get(editor.document.languageId);
            const printStatement = this._printStatementBuilder.build(printStatementConfig, selectedText);
