...
const PrintStatementConfigService = require('./print-statement-config-service');
...
class AppFactory {
    ...
    create(vscode, logger) {
        ...
        const printStatementConfigService = new PrintStatementConfigService({workspace: vscode.workspace});
        const textBuffer = new TextBuffer();
        return new App({
            counterInputBox,
            printStatementBuilder,
            printStatementCounter,
            printStatementConfigService,
            textBuffer,
            logger
        });
    }
